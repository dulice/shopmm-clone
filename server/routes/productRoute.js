const { createProduct, getProducts, categoriesWithImage, sameCategoryProducts, searchProduct, product, writeReview, updateProduct, deleteProduct, myProducts } = require("../controllers/productController");
...
router.get("/owner/:ownerId", myProducts); // get owner products
