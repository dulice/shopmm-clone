...
const { createOrder, getOrders, getUsers, payment, orderSummary, order, deliverOrder } = require("../controllers/orderController");
...
router.get("/userOrder/:customerId", ); // customer orders
