...
const ProductCreate = () => {
  ...
  useEffect(() => {
    const subcategories = categoriesData.find((cat) =>
  ...
  return (
    <Container>
      ...
      <form encType="multipart/form-data" onSubmit={handleUploadProduct}>
        <Stack spacing={2}>
          <Box
            fullWidth
            sx={{
          ...
          <Grid container>
            ...
            <Grid item xs={4}>
              <FormControl fullWidth>
                ...
                >
                  {category &&
                    Object.entries(subcategories.subCategories).map(
                      ([key, value]) => (
            ...
            <Grid item xs={4}>
              <FormControl fullWidth>
                ...
                >
                  {subcategory &&
                    subcategories.subCategories[subcategory].map(
                      (el, index) => (
